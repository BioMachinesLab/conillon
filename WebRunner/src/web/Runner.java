...
public class Runner extends JFrame implements MouseInputListener, KeyListener, WebRunner{
	...
	private class Controller implements Runnable{
		...
		public void run() {
			while (true){
				try {
					//					procs [pos] = Runtime.getRuntime().exec("cmd /C java web/Launcher " + pos +" web.AppletRunner");
					procs [pos] = Runtime.getRuntime().exec("cmd /C start cmd /C java web/Launcher " + pos +" web.AppletRunner");
					//					procs [pos] = Runtime.getRuntime().exec("cmd /K start cmd /K java web/Launcher " + pos +" web.AppletRunner");
					procs [pos].waitFor();
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
