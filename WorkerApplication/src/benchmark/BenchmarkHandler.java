...
public class BenchmarkHandler extends Task {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2141261065673518517L;
	/**
	...
	public void run() {
		...
		this.decimal = this.getDecimal(index);
		
		
		//System.out.println("Decimal digits of pi at position " + NUM + ": " +  + "\n");
	...
	public Result getResult() {
		SimpleBenchmarkResult result = new SimpleBenchmarkResult(this.decimal);
		return result;
	}
